...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        console.log(
            chalk.green.bold('✅ Vethalam Login successful!')
        );

        console.log(
            chalk.blueBright.italic('⬇️ Vethalam Installing external plugins...')
        );
        ...
        console.log(
            chalk.green.bold('✅️ Vethalam bot v1 working!')
        );
    });
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~______~ Vethalam bot v1 ~______~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
